...
document.addEventListener("DOMContentLoaded", function () {
	...
	// 🔥 Constante para la URL de los datos de vuelos
 ...
 */
	...
	/**
 * 🛠️ Verifica si todos los checkboxes están seleccionados y actualiza el "Seleccionar Todos"
 */
	...
	function addEditFunctionality() {
		...
		document.getElementById("saveChanges").addEventListener("click", function () {
			const oldFlightNumber = this.getAttribute("data-flight-number");

			let flightIndex = filteredFlights.findIndex(flight => flight.flightNumber === oldFlightNumber);
			if (flightIndex !== -1) {
				// Actualizamos todos los datos del vuelo
				filteredFlights[flightIndex].flightNumber = document.getElementById("editFlightNumber").value;
				filteredFlights[flightIndex].airline = document.getElementById("editAirline").value;
				filteredFlights[flightIndex].destination = document.getElementById("editDestination").value;
				filteredFlights[flightIndex].departure = document.getElementById("editDeparture").value;
				filteredFlights[flightIndex].status = document.getElementById("editStatus").value;
				filteredFlights[flightIndex].statusClass = getStatusClass(filteredFlights[flightIndex].status);
			}
